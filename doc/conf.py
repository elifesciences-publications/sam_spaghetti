...
# -*- coding: utf-8 -*-
#
# Package sam_spaghetti documentation build configuration file, created by
...
project = u"sam_spaghetti"
copyright = u"2018, sam_spaghetti"
...
modindex_common_prefix = ['sam_spaghetti']
...
htmlhelp_basename = "sam_spaghetti_doc"
...
# [howto/manual]).
latex_documents = [
    (u"index", u"sam_spaghetti.tex",
     u"sam_spaghetti Documentation",
     u"Guillaume Cerutti", u"manual"),
]
...
texinfo_documents = [
    (u"index", u"sam_spaghetti",
     ...
     u"Guillaume Cerutti",
     u"sam_spaghetti",
     u"SAM Sequence Primordia Alignment, GrowtH Estimation, Tracking & Temporal Indexation",
     u"Miscellaneous"),
]
