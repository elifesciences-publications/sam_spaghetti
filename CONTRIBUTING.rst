...
Ready to contribute? Here's how to set up `sam_spaghetti` for local development.

1. Fork the `sam_spaghetti` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/sam_spaghetti.git
...
tests, including testing other Python versions with tox::
    ...
    (dvlpt)$ cd sam_spaghetti
    (dvlpt) sam_spaghetti$ flake8
    (dvlpt) sam_spaghetti$ nosetests
    (dvlpt) sam_spaghetti$ tox
...
3. The pull request should work for Python 2.7, 3.4, and 3.5. Check
   https://travis-ci.org/Guillaume Cerutti/sam_spaghetti/pull_requests
...
.. _issues: https://github.com/Guillaume Cerutti/sam_spaghetti/issues
